...
.data
    ...
    youwin_hex_arr: .word 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0x1, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0xffffff, 0x1, 0xffffff, 0x1, 0x1, 0x1, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0x1, 0xffffff, 0x1, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0x1, 0xffffff, 0x1, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0x1, 0x1, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0xffffff, 0x1, 0xffffff, 0x1, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0x1, 0x1, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0xffffff, 0x1, 0x1, 0xffffff, 0xffffff, 0xffffff, 0x1, 0x1, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0x1, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0x1, 0x1, 0xffffff, 0x1, 0xffffff, 0xffffff, 0x1, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff, 0xffffff
...
.macro start_level_three
    ...
    # Background
    li CLEAR_COLOUR, CAVE_BACKGROUND
    apply_rect, colour, CLEAR_COLOUR
    ...
    # Platforms
    set_rect 16, 80, 29, 2 # 4 20 33 22
    draw_platform $t7
    set_rect 208, 52, 8, 2 # 52 13 60 15
    draw_platform $t7
    set_rect 16, 136, 8, 2 # 4 34 12 36
    draw_platform $t7
    set_rect 152, 136, 22, 2 # 38, 34 60 36
    draw_platform $t7

    # Enemies
    add_basic_enemy_object 100, 60
    add_basic_enemy_object 152, 220
    add_basic_enemy_object 188, 220
    # Coins
    add_coin_object 28, 120
    add_coin_object 28, 152
    add_coin_object 216, 36
    add_coin_object 124, 220
    add_coin_object 220, 220
    # Moving enemies
    add_moving_enemy_object 24, 168, 4, 24, 88
    add_moving_enemy_object 164, 116, 4, 164, 204
    add_bat_object 56, 100, 4, 56, 212
    add_bat_object 124, 168, 4, 124, 216
    add_bat_object 216, 192, 4, 124, 216
.end_macro
...
.macro display_game_over
    set_rect 0, 0, 64, 64
    li CLEAR_COLOUR 0xffffff
    apply_rect colour CLEAR_COLOUR

    # ok to modify s0-s1 because it's being reset later
    ...
    draw_stars: bge $t6, $t7, done_draw_stars
        ...
        # One yellow star for each health point
        pick_gray_star: bgtz $s1, pick_yellow_star
            la $t5, gray_star_hex_arr
            j draw_star
        pick_yellow_star:
            la $t5, yellow_star_hex_arr
    ...
    # R or Q to restart/quit
    wait_for_input:
        get_keypress $t0
        end_r: bne $t0, 114, end_q
            j main
        end_q: bne $t0, 113, wait_for_input
            li $v0, 10
            syscall
.end_macro
...
select_level:
    reset_data  # Doesn't reset health
